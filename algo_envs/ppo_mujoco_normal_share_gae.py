...
train_config['tensorboard_comment'] = 'intercepted_gae384'

class PPOMujocoNormalShareGAENet(AlgoBase.AlgoBaseNet):
    """
    ...
    def __init__(self):
        super(PPOMujocoNormalShareGAENet,self).__init__()
...
class PPOMujocoNormalShareGAEUtils(AlgoBase.AlgoBaseUtils):
    pass
                    
class PPOMujocoNormalShareGAEAgent(AlgoBase.AlgoBaseAgent):
    """
    Agent class used with continues PPO, allowing collect data and evaluate agents.

    Args:
        sample_net: policy network (default: PPOMujocoNormalShareGAENet)
    ...
    Example:
        ...
        >>> sample_agent = PPOMujocoNormalShareGAEAgent(train_net,model_dict,is_checker=False)
    ...
    def __init__(self,sample_net:PPOMujocoNormalShareGAENet,model_dict,is_checker):
        super(PPOMujocoNormalShareGAEAgent,self).__init__()
    ...
    def sample_env(self):
        ...
        # Deleting the length before self.gae_length
...
class PPOMujocoNormalShareGAECalculate(AlgoBase.AlgoBaseCalculate):

    """
    training class used with continues PPO

    Args:
        share_model: policy network (default: PPOMujocoNormalShareGAENet)
        model_dict: a dict of model configuration
    ...
    def __init__(self,share_model:PPOMujocoNormalShareGAENet,model_dict,calculate_index):
        super(PPOMujocoNormalShareGAECalculate,self).__init__()
        self.model_dict = model_dict
        ...
        self.calculate_net = PPOMujocoNormalShareGAENet()
...
if __name__ == "__main__":
    ...
    comment = "_PPOMujocoNormalShare_" + current_env_name + "_" + train_config['tensorboard_comment']
    ...
    sample_agent = PPOMujocoNormalShareGAEAgent(train_net,model_dict,is_checker=False)
    check_agent = PPOMujocoNormalShareGAEAgent(train_net,model_dict,is_checker=True)
    calculate = PPOMujocoNormalShareGAECalculate(train_net,model_dict,0)
