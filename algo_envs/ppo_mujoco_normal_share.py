...
class PPOMujocoNormalShareNet(AlgoBase.AlgoBaseNet):
    ...
    def __init__(self):
        super(PPOMujocoNormalShareNet,self).__init__()
...
class PPOMujocoNormalShareUtils(AlgoBase.AlgoBaseUtils):
    pass
                    
class PPOMujocoNormalShareAgent(AlgoBase.AlgoBaseAgent):
    """
    ...
    """
    def __init__(self,sample_net:PPOMujocoNormalShareNet,model_dict,is_checker):
        super(PPOMujocoNormalShareAgent,self).__init__()
...
class PPOMujocoNormalShareCalculate(AlgoBase.AlgoBaseCalculate):
    ...
    def __init__(self,share_model:PPOMujocoNormalShareNet,model_dict,calculate_index):
        super(PPOMujocoNormalShareCalculate,self).__init__()
        self.model_dict = model_dict
        ...
        self.calculate_net = PPOMujocoNormalShareNet()
...
if __name__ == "__main__":
    ...
    sample_agent = PPOMujocoNormalShareAgent(train_net,model_dict,is_checker=False)
    check_agent = PPOMujocoNormalShareAgent(train_net,model_dict,is_checker=True)
    calculate = PPOMujocoNormalShareCalculate(train_net,model_dict,0)
